      ...
      .py-3.py-md-4(titulo="La información es base de conocimiento")
        .row
          .col-lg-6.mb-4.mb-md-0
            h4.txt--tabColor La información es base de conocimiento
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema1/tab_01.png', alt='',style="width:450px;").m-auto 

      .py-3.py-md-4(titulo="Análisis de la información")
        .row
          .col-lg-6.mb-4.mb-md-0
            h4.txt--tabColor Análisis de la información
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema1/tab_02.png', alt='',style="width:450px;").m-auto

      .py-3.py-lg-4(titulo="Curaduría de la información")
        .row
          .col-lg-6.mb-4.mb-md-0
            h4.txt--tabColor Curaduría de la información
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema1/tab_03.png', alt='',style="width:450px;").m-auto

      .py-3.py-md-4(titulo="Valide los datos y las fuentes de información")
        .row
          .col-lg-6.mb-4.mb-md-0
            h4.txt--tabColor Valide los datos y las fuentes de información
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema1/tab_04.png', alt='',style="width:450px;").m-auto 

      .py-3.py-md-4(titulo="Mercados y tendencias")
        .row
          .col-lg-6.mb-4.mb-md-0
            h4.txt--tabColor Mercados y tendencias
          ...
          .col-lg-6
            figure
              img(src='@/assets/curso/tema1/tab_05.png', alt='',style="width:450px;").m-auto    
